...
from airflowplugins.utils.utils import get_curve_params
...
from airflowplugins.utils.utils import trigger_push_result_to_mq
import json
...
class TriggerAnalyzeHook(BaseHook, ABC):
    ...
    def trigger_push_result_dag(params):
        ...
        from airflowplugins.publish_result.publish_result_plugin import PublishResultHook
